...
class CreaturesRepository @Inject constructor() {
    ...
    init {
        ...
        val creature3 = Creature(3, "Android", "https://i.imgur.com/rNKVxSt.png")
        val creature4 = Creature(4, "C", "https://i.imgur.com/iWeXxA9.png")
        val creature5 = Creature(5, "C++", "https://i.imgur.com/YYkSF5A.png")
        val creature6 = Creature(6, "C#", "https://i.imgur.com/rNKVxSt.png")
        val creature7 = Creature(7, "JavaScript", "https://imgur.com/WEKXaw3.png")
